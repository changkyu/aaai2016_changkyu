...
%  as a cell array given J nodes. Network topologies are 
%   (1) complete 
%   (2) ring 
%   (3) star 
%   (4) chain 
%   (5) clusters: only valid when J > 4 && mod(J,4) == 0.
%   (6) clusters: only valid when J > 4 && mod(J,4) == 0.
%
% Input
%  J    : Number of nodes in network
%
% Output
%  Earr : 4 or 6 element cell array each with an adjacent matrix
%
% Implemented/Modified
%  by     Sejong Yoon (sjyoon@cs.rutgers.edu)
%  on     2011.10.07 (last modified on 2015/03/21)
