function MissIDX = gen_sfm_missing_mnar(X, ratio)
...
%  Other assumptions are possible but our purpose of the demonstration is 
%  to show that our model is resistent to correlated missing values.
%
% Input
% X        : Input matrix
% ratio    : Missing ratio
